...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    try:                  
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            ...
            # Use Markdown or HTML formatting here
            await client.send_cached_media(
                chat_id=query.from_user.id, 
                file_id=file_id, 
                caption=f_caption, 
                parse_mode="Markdown",  # or "HTML" based on your preference
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ 🔈", url="https://t.me/Unlimited_Movie_Zone")
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ', url='https://github.com/KahaPutha/PROFESSOR-BOT')
            ],[
